...
namespace dso
{
	...
	{
		float E = 0;			// 能量值
		int numTermsInE = 0;	// E 中数目
		int numTermsInWarped = 0;
		int numSaturated = 0;	// 大于阈值数目
	 ...
	 * @param lastToNew_out 预测的相对位姿
	 * @param aff_g2l_out 预测的相对光度参数(初始化为0)
	 * @param coarsestLvl 金字塔层数
	 * @param minResForAbort 用来判断是否合适的误差
	 * @return bool值 是否成功
	 */
